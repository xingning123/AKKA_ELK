...
//                TraiteurDeCommande traiteur = new TraiteurDeCommande();
//
//                ArrayList<Etat> etatList = new ArrayList<>();
//                etatList.add(new Etat("Etat1", new Date(), new Date()));
...
//                traiteur.handleMessage(message, commande);
//
//                // Vérifie si un nouvel état a été ajouté à la commande
//                assert traiteur.getEtatList().size() == 1;
//            }
//        };
//    }
//
