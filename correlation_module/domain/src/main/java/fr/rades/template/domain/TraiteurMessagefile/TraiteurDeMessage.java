...
public class TraiteurDeMessage {
    ...
    public List<MessageTraiteePourCommande> processMessage(MessageTronqueurTraiteur message, ActorContext context, int retryCount,ActorRef createurLotRequetes) {
        ...
        try {
            ...
            if (retryCount < MAX_RETRY_COUNT) {
                ...
                // Retry processing the message with an incremented retry count
